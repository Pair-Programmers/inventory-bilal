        ...
        <div class="ibox-content">
            ...
            <form method="post" class="form-horizontal"  action=""
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="name" disabled value="{{$vendor->name}}"  required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="email" class="form-control" name="email" disabled value="{{$vendor->email}}" placeholder="Optional">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" disabled name="address" value="{{$vendor->address}}"  placeholder="Optional">
                    </div>
